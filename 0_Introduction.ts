...
function calculate (number1, number2, number3 = 0) {
    return number1 + number2 + number3;
}
...
function dummyFunction (item?: number) {
...
var unionDataType : number | boolean;
...
var unionDataType2 : number | boolean | string;
